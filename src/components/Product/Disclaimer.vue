      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p class="mb-4">
              At Animal Care, we provide a wide range of services to ensure the
          ...
          <div>
            ...
            <p class="mb-4">
              In addition to our services, we offer a wide range of high-quality
              products for your animals. Our product selection includes:
            </p>
            <ul class="list-disc pl-6 mb-6">
